...
export default {
  ...
  methods:{
    ...
    filesave:function(){
      ...
      image.append('open_id',(new Date()).getTime())
      image.append('source_type',"WX_ACTIVITIES_LINE")
      image.append('pkvalue',this.line_id)
      image.append('user_id','1')
      image.append('filePath',this.file);
...
.boxw{min-height:20rem;min-height:calc(100% - 7.7rem);}
.hide{display:none;}
